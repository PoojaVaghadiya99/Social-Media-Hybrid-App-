...
<nav class="container mb-3">
  <div class="col-12 nav nav-tabs" id="nav-tab" role="tablist">
    <a class="col-3 nav-item nav-link active" id="nav-profile-tab_img" data-toggle="tab" href="#nav-profile_img" role="tab" aria-controls="nav-profile_img" aria-selected="false">Profile</a>
    <a class="col-3 nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Personal</a>
    <a class="col-3 nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Password</a>
    <a class="col-3 nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Account</a>
  </div>
</nav>
